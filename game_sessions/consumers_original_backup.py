...
class GameConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        try:
            ...
            # Mastermind-specific messages now handled by dedicated mastermind consumer
            # See: mastermind/consumers.py
    ...
    # Mastermind-specific event handlers moved to mastermind/consumers.py
    ...
    # Mastermind-specific handlers moved to mastermind/consumers.py
